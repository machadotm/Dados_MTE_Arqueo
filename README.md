# Dados relativos aos vínculos trabalhistas da ocupação de arqueólogo (1994-2021)
...
A pasta Scripts contém códigos escritos na linguagem R para carregar, processar e transformar os dados disponibilizados, em formato numérico e codificado, para registros com informações mais compreensíveis, trocando números por palavras como "Admissão", "Desligamento", "São Paulo", "Ensino Superior Completo", etc. O resultado final converte os dados tratados e limpos em um arquivo Excel filtrado e organizado.
